...
EAStep ngdbuild -intstyle ise -p xc6slx16csg324-3 -dd _ngo -uc "my_dff.ucf" "my_dff.edf"
EAStep map -intstyle pa -w "my_dff.ngd"
EAStep par -intstyle pa "my_dff.ncd" -w "my_dff_routed.ncd"
EAStep trce -intstyle ise -o "my_dff.twr" -v 30 -l 30 "my_dff_routed.ncd" "my_dff.pcf"
EAStep xdl -secure -ncd2xdl -nopips "my_dff_routed.ncd" "my_dff_routed.xdl"
