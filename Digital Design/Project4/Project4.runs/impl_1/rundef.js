...
ISEStep( "ngdbuild",
         "-intstyle ise -p xc6slx16csg324-3 -dd _ngo -uc \"my_dff.ucf\" \"my_dff.edf\"" );
ISEStep( "map",
         "-intstyle pa -w \"my_dff.ngd\"" );
ISEStep( "par",
         "-intstyle pa \"my_dff.ncd\" -w \"my_dff_routed.ncd\"" );
ISEStep( "trce",
         "-intstyle ise -o \"my_dff.twr\" -v 30 -l 30 \"my_dff_routed.ncd\" \"my_dff.pcf\"" );
ISEStep( "xdl",
         "-secure -ncd2xdl -nopips \"my_dff_routed.ncd\" \"my_dff_routed.xdl\"" );
