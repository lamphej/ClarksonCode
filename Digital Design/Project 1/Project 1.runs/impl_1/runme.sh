...
EAStep ngdbuild -intstyle ise -p xc6slx16csg324-3 -dd _ngo -uc "and_or_top.ucf" "and_or_top.edf"
EAStep map -intstyle pa -w "and_or_top.ngd"
EAStep par -intstyle pa "and_or_top.ncd" -w "and_or_top_routed.ncd"
EAStep trce -intstyle ise -o "and_or_top.twr" -v 30 -l 30 "and_or_top_routed.ncd" "and_or_top.pcf"
EAStep xdl -secure -ncd2xdl -nopips "and_or_top_routed.ncd" "and_or_top_routed.xdl"
