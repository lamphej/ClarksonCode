...
ISEStep( "ngdbuild",
         "-intstyle ise -p xc6slx16csg324-3 -dd _ngo -uc \"FourBitAdder.ucf\" \"FourBitAdder.edf\"" );
ISEStep( "map",
         "-intstyle pa -w \"FourBitAdder.ngd\"" );
ISEStep( "par",
         "-intstyle pa \"FourBitAdder.ncd\" -w \"FourBitAdder_routed.ncd\"" );
ISEStep( "trce",
         "-intstyle ise -o \"FourBitAdder.twr\" -v 30 -l 30 \"FourBitAdder_routed.ncd\" \"FourBitAdder.pcf\"" );
ISEStep( "xdl",
         "-secure -ncd2xdl -nopips \"FourBitAdder_routed.ncd\" \"FourBitAdder_routed.xdl\"" );
