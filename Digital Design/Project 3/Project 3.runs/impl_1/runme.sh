...
EAStep ngdbuild -intstyle ise -p xc6slx16csg324-3 -dd _ngo -uc "FourBitAdder.ucf" "FourBitAdder.edf"
EAStep map -intstyle pa -w "FourBitAdder.ngd"
EAStep par -intstyle pa "FourBitAdder.ncd" -w "FourBitAdder_routed.ncd"
EAStep trce -intstyle ise -o "FourBitAdder.twr" -v 30 -l 30 "FourBitAdder_routed.ncd" "FourBitAdder.pcf"
EAStep xdl -secure -ncd2xdl -nopips "FourBitAdder_routed.ncd" "FourBitAdder_routed.xdl"
